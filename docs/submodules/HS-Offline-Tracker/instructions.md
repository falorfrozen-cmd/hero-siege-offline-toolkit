...
- **The replacement lives in the hub:** [`third_party/yytoolkit/`](../../../third_party/yytoolkit/README.md) — upstream v4.0.1 (`5a95e46`) plus a documented patch series, built by `tools/build_yytoolkit.py`. Built and host-tested; **never launched against the game**, so nothing about startup or lag is measured. This repository still bundles `bb113eef…`.
